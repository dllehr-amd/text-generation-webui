...
def install_webui():
    ...
    if "GPU_CHOICE" in os.environ:
        ...
        print()
        print("A) NVIDIA")
        print("B) AMD (Linux/MacOS only. Requires ROCm SDK 5.7 on Linux)")
    ...
    if any((is_windows(), is_linux())) and choice == "A":
        ...
        if is_linux():
            install_pytorch = "python -m pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/nightly/rocm5.7"
        else:
